## Project đã dùng lại
- Hiện tại LuckyVN đã đổi nhiệm vụ sang dạng mới, nó không ổn định và tôi không có thời gian nên tôi sẽ dừng dự án này vĩnh viễn.
...
- Nếu bạn đã có tệp .env, vui lòng bỏ qua phần này
- Nếu bạn mới tải, vui lòng đổi tên tệp default.env thành .env
...
NOPECHA_KEY=<API key của NopeCHA> (KHÔNG BẮT BUỘC)
```
